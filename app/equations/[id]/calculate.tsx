...
export default function Calculate({
  ...
  return (
    <form
      className="grid border border-zinc-200 dark:border-zinc-800 shadow-sm bg-white dark:bg-zinc-950 rounded-2xl"
        ...
        {variablesData.map((v, i) => (
          ...
          >
            ...
            <div className="flex w-full items-center">
              <label className="bg-zinc-50 dark:bg-zinc-950 rounded-l-xl border-l border-y border-zinc-200 dark:border-zinc-800 text-black dark:text-white px-4 py-1 h-10 min-w-10 w-fit flex items-center justify-center font-mono text-xs">
                <span>{v.latex}</span>
              </label>
              <Input

...
export default function ComposeSteps() {
  ...
  return (
    <div>
      <section
        className={cn(
          "flex flex-col p-3 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm rounded-2xl overflow-clip transition-all"
        )}
      >
        <div
          className={cn(
      ...
      {latexInput.variables.length > 0 && (
        <>
          ...
          <section className="bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-clip animation-delay-75 opacity-0 animate-blur-in">
            <section className="p-3 sm:p-5">
              <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-3 sm:p-4">
                <p className="text-sm p-0 dark:text-zinc-400">
                ...
                {latexInput.variables.map((variable, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 flex items-center gap-1.5">
                      ...
                      <Input placeholder={`Unit`} className="w-20 rounded-lg" />
                    </div>
                  </fieldset>
                ))}
              </section>
